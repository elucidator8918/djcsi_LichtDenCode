...
const Aboutus = () => {
  ...
  <div className="mx-auto max-w-7xl px-6 lg:px-8">
    <div className="mx-auto max-w-2xl lg:mx-0">
      ...
      <p className="mt-6 text-lg leading-8 text-gray-300">Authentica is also a type of digital document security technology that can be used to protect sensitive or confidential documents from unauthorized access or sharing.</p>
    </div>
    <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
      
      <dl className="mt-16  grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
        <div className="flex flex-col-reverse">
          <dt className="text-2xl leading-7 text-gray-300 m-4">Offices worldwide</dt>
          <dd className="text-4xl font-bold leading-9 tracking-tight text-white mb-2">12</dd>
        </div>

        <div className="flex flex-col-reverse">
          <dt className="text-2xl leading-7 text-gray-300 m-4">Full-time colleagues</dt>
          <dd className="text-4xl font-bold leading-9 tracking-tight text-white mb-2">300+</dd>
        </div>

        <div className="flex flex-col-reverse">
          <dt className="text-2xl leading-7 text-gray-300 m-4">Hours per week</dt>
          <dd className="text-4xl font-bold leading-9 tracking-tight text-white mb-2">40</dd>
        </div>

        <div className="flex flex-col-reverse">
          <dt className="text-2xl leading-7 text-gray-300 m-4">Paid time off</dt>
          <dd className="text-4xl font-bold leading-9 tracking-tight text-white mb-2">Unlimited</dd>
        </div>
      </dl>
    </div>
  </div>
